var functionsClienteAlterar = {
    ConsultarCep: function (cep, id) {
        fGlobal.Ajax(gHostProjeto + "Cliente/ConsultarCEP?cep=" + cep + "&id=" + id, "GET", null, functionsClienteAlterar.HtmlConsultarCep, null, functionsClienteAlterar.EscondeModal, functionsClienteAlterar.MostraModal);
    },
    HtmlConsultarCep: function (data) {
        var dados = JSON.parse(data.retorno);
        var id = JSON.parse(data.id);

        document.getElementById("EnderecosCliente[" + id + "].Endereco").value = dados.logradouro;
        document.getElementById("EnderecosCliente[" + id + "].Cidade").value = dados.localidade;
        document.getElementById("EnderecosCliente[" + id + "].Complemento").value = dados.complemento;
        document.getElementById("EnderecosCliente[" + id + "].Bairro").value = dados.bairro;
        document.getElementById("EnderecosCliente[" + id + "].Estado").value = dados.uf;
    },
    ConsultarCepPF: function (cep, id) {
        fGlobal.Ajax(gHostProjeto + "Cliente/ConsultarCEP?cep=" + cep + "&id=" + id, "GET", null, functionsClienteAlterar.HtmlConsultarCepPF, null, functionsClienteAlterar.EscondeModal, functionsClienteAlterar.MostraModal);
    },
    ...
    CriarHTMLAlterarEnderecoPF: function (i) {
        var html = "";
        if (i !== 0) {
        ...
        html += '<input type="text" class="form-control cepPF" name="EnderecosCliente[' + i + '].CEP" id="EnderecosCliente[' + i + '].CEP" /> ';
        ...
        html += '<input type="text" class="form-control" name="EnderecosCliente[' + i + '].Endereco" id="EnderecosCliente[' + i + '].Endereco" /> ';
        ...
        html += '</div> ';
        html += '<div class="col-md-3"> ';
        html += '<input type="number" class="form-control" name="EnderecosCliente[' + i + '].Numero" id="EnderecosCliente[' + i + '].Numero" /> ';
        ...
        html += '<input type="text" class="form-control" name="EnderecosCliente[' + i + '].Complemento" id="EnderecosCliente[' + i + '].Complemento" /> ';
        ...
        html += '<input type="text" class="form-control" name="EnderecosCliente[' + i + '].Cidade" id="EnderecosCliente[' + i + '].Cidade" /> ';
        ...
        html += '</div> ';
        html += '<div class="col-md-6"> ';
        html += '<input type="text" class="form-control" name="EnderecosCliente[' + i + '].Bairro" id="EnderecosCliente[' + i + '].Bairro" /> ';
        ...
        html += '</div> ';
        html += '<div class="col-md-3"> ';
        html += '<select name="EnderecosCliente[' + i + '].Estado" id="EnderecosCliente[' + i + '].Estado" class="form-control"> ';
    ...
    CriaHTMLAlterarContatoPF: function (i) {
        var html = "";
        if (i !== 0) {
        ...
        html += '<div class="col-md-8"> ';
        html += '<input type="text" class="form-control nomePF" name="ContatosCliente[' + i + '].Nome" id="ContatosCliente[' + i + '].Nome" /> ';
        ...
        html += '<div class="col-md-4"> ';
        html += '<input type="text" class="form-control" name="ContatosCliente[' + i + '].Cargo" id="ContatosCliente[' + i + '].Cargo" /> ';
        ...
        html += '<div class="col-md-4"> ';
        html += '<input type="text" class="form-control" name="ContatosCliente[' + i + '].Telefone" id="ContatosCliente[' + i + '].Telefone" /> ';
        ...
        html += '<div class="col-md-4"> ';
        html += '<input type="text" class="form-control" name="ContatosCliente[' + i + '].Email" id="ContatosCliente[' + i + '].Email" /> ';
...
$(function () {
    ...
    $(document).on('blur', '.cepPJ', function () {
        ...
        if (fGlobal.IsNotEmpty(cep)) {
            ...
            functionsClienteAlterar.ConsultarCep(cep, id);
        }
    });
    ...
    $(document).on('blur', '.cepPF', function () {
        ...
        if (fGlobal.IsNotEmpty(cep)) {
            id = $(this).attr('id').split('[')[1].substring(0, 1);
            functionsClienteAlterar.ConsultarCepPF(cep, id);
        }
    });

    if ($('.enderecoPessoaFisica').length <= 0) {
        functionsClienteAlterar.CriarHTMLAlterarEnderecoPF(0);
    }

    if ($('.contatoPessoaFisica').length <= 0) {
        functionsClienteAlterar.CriaHTMLAlterarContatoPF(0);
    }
...
$(document).on('click', '.btnRemoverEnderecoPessoaJuridica', function () {
    ...
    for (var i = linhaAtual + 1; i <= qtdLinhas; i++) {
        document.getElementById('EnderecosCliente[' + i + '].CEP').name =
            "EnderecosCliente[" + (i - 1).toString() + "].CEP";
        document.getElementById('EnderecosCliente[' + i + '].CEP').id =
            "EnderecosCliente[" + (i - 1).toString() + "].CEP";
        document.getElementById('EnderecosCliente[' + i + '].Endereco').name =
            "EnderecosCliente[" + (i - 1).toString() + "].Endereco";
        document.getElementById('EnderecosCliente[' + i + '].Endereco').id =
            "EnderecosCliente[" + (i - 1).toString() + "].Endereco";
        document.getElementById('EnderecosCliente[' + i + '].Numero').name =
            "EnderecosCliente[" + (i - 1).toString() + "].Numero";
        document.getElementById('EnderecosCliente[' + i + '].Numero').id =
            "EnderecosCliente[" + (i - 1).toString() + "].Numero";
        document.getElementById('EnderecosCliente[' + i + '].Complemento').name =
            "EnderecosCliente[" + (i - 1).toString() + "].Complemento";
        document.getElementById('EnderecosCliente[' + i + '].Complemento').id =
            "EnderecosCliente[" + (i - 1).toString() + "].Complemento";
        document.getElementById('EnderecosCliente[' + i + '].Cidade').name =
            "EnderecosCliente[" + (i - 1).toString() + "].Cidade";
        document.getElementById('EnderecosCliente[' + i + '].Cidade').id =
            "EnderecosCliente[" + (i - 1).toString() + "].Cidade";
        document.getElementById('EnderecosCliente[' + i + '].Bairro').name =
            "EnderecosCliente[" + (i - 1).toString() + "].Bairro";
        document.getElementById('EnderecosCliente[' + i + '].Bairro').id =
            "EnderecosCliente[" + (i - 1).toString() + "].Bairro";
        document.getElementById('EnderecosCliente[' + i + '].Estado').name =
            "EnderecosCliente[" + (i - 1).toString() + "].Estado";
        document.getElementById('EnderecosCliente[' + i + '].Estado').id =
            "EnderecosCliente[" + (i - 1).toString() + "].Estado";
    }
...
$(document).on('click', '.btnRemoverContatoPessoaJuridica', function () {
    ...
    for (var i = linhaAtual + 1; i <= qtdLinhas; i++) {
        document.getElementById('ContatosCliente[' + i + '].Nome').name =
            "ContatosCliente[" + (i + - 1).toString() + "].Nome";
        document.getElementById('ContatosCliente[' + i + '].Nome').id =
            "ContatosCliente[" + (i + - 1).toString() + "].Nome";
        document.getElementById('ContatosCliente[' + i + '].Cargo').name =
            "ContatosCliente[" + (i + - 1).toString() + "].Cargo";
        document.getElementById('ContatosCliente[' + i + '].Cargo').id =
            "ContatosCliente[" + (i + - 1).toString() + "].Cargo";
        document.getElementById('ContatosCliente[' + i + '].Telefone').name =
            "ContatosCliente[" + (i + - 1).toString() + "].Telefone";
        document.getElementById('ContatosCliente[' + i + '].Telefone').id =
            "ContatosCliente[" + (i + - 1).toString() + "].Telefone";
        document.getElementById('ContatosCliente[' + i + '].Email').name =
            "ContatosCliente[" + (i + - 1).toString() + "].Email";
        document.getElementById('ContatosCliente[' + i + '].Email').id =
            "ContatosCliente[" + (i + - 1).toString() + "].Email";
    }
    $(this).parent().parent().remove();
});
...
$("#btnCriarEnderecoPessoaFisicaAlterar").on('click', function () {
    ...
    functionsClienteAlterar.CriarHTMLAlterarEnderecoPF(i);
});
...
$("#btnCriarContatoPessoaFisicaAlterar").on('click', function () {
    ...
    functionsClienteAlterar.CriaHTMLAlterarContatoPF(i);
});
